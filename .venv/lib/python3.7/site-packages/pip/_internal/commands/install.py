...
def get_check_bdist_wheel_allowed(
    ...
    def check_binary_allowed(req: InstallRequirement) -> bool:
        ...
        allowed_formats = format_control.get_allowed_formats(
            canonical_name)
...
class InstallCommand(RequirementCommand):
    ...
    def add_options(self) -> None:
        ...
        self.cmd_opts.add_option(
            cmdoptions.override_externally_managed())
        ...
        try:
            ...
            if conflicts is not None:
                self._warn_about_conflicts(
                    conflicts, resolver_variant=self.determine_resolver_variant(options), )
        ...
        for lib_dir in lib_dir_list:
            for item in os.listdir(lib_dir):
                if lib_dir == data_dir:
                    ...
                    if any(s.startswith(ddir)
                           for s in lib_dir_list[:-1]):
                        continue
...
def decide_user_install(
    ...
    # If we are here, user installs have not been explicitly
    # requested/avoided
