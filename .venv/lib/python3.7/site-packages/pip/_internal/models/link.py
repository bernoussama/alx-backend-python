...
class LinkHash:
    ...
    def split_hash_name_and_value(
            cls, url: str) -> Optional["LinkHash"]:
...
def _ensure_quoted_url(url: str) -> str:
    ...
    # If the netloc is empty, then the URL refers to a local filesystem
    # path.
...
class Link(KeyBasedCompareMixin):
    ...
    def from_json(
        ...
        # The Link.yanked_reason expects an empty string instead of a
        # boolean.
    ...
    def from_element(
        ...
        dist_info_metadata = anchor_attribs.get(
    ...
    def metadata_link(self) -> Optional["Link"]:
        ...
        # but there is no information about its checksum or anything
        # else.
