...
def freeze(
    ...
    if requirement:
        ...
        # give an accurate warning if a requirement appears multiple
        # times.
                        ...
                        if line_req_canonical_name not in installations:
                            ...
                            if not req_files[line_req.name]:
                                logger.warning(
                                    ...
                                    "package %r is not installed", req_file_path, COMMENT_RE.sub(
                                        "", line).strip(), line_req.name, )
                            else:
                                req_files[line_req.name].append(
                                    req_file_path)
                        else:
...
def _get_editable_info(dist: BaseDistribution) -> _EditableInfo:
    ...
    location = os.path.normcase(
        os.path.abspath(editable_project_location))
