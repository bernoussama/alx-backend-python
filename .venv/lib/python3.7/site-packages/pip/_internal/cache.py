...
class Cache:
    ...
    def __init__(
        ...
        assert self.allowed_formats.union(
            _valid_formats) == _valid_formats
...
class WheelCache(Cache):
    ...
    def __init__(
            self,
            cache_dir: str,
            format_control: Optional[FormatControl] = None) -> None:
    ...
    def get(
        ...
        cache_entry = self.get_cache_entry(
            link, package_name, supported_tags)
