...
class InstallRequirement:
    ...
    def __init__(
        ...
        # This holds the Distribution object if this requirement is
        # already installed.
    ...
    def setup_py_path(self) -> str:
        ...
        setup_py = os.path.join(
            self.unpacked_source_directory, "setup.py")
    ...
    def setup_cfg_path(self) -> str:
        ...
        setup_cfg = os.path.join(
            self.unpacked_source_directory, "setup.cfg")
    ...
    def prepare_metadata(self) -> None:
        ...
        # Act on the newly generated metadata, based on the name and
        # version.
        if not self.name:
    ...
    def update_editable(self) -> None:
        ...
        # So here, if it's neither a path nor a valid VCS URL, it's a
        # bug.
    ...
    def archive(self, build_dir: Optional[str]) -> None:
        ...
        create_archive = True
        archive_name = "{}-{}.zip".format(self.name,
                                          self.metadata["version"])
    ...
    def install(
        ...
        if self.is_wheel:
            ...
            direct_url = None
            # TODO this can be refactored to direct_url =
            # self.download_info
            if self.editable:
