...
def track(
    ...
    columns: List["ProgressColumn"] = ([TextColumn(
...
def wrap_file(
    ...
    *,
    ...
    reader = progress.wrap_file(
        file, total=total, description=description)
...
class ProgressColumn(ABC):
    ...
    def __init__(self, table_column: Optional[Column] = None) -> None:
        ...
        self._renderable_cache: Dict[TaskID,
                                     Tuple[float, RenderableType]] = {}
...
class BarColumn(ProgressColumn):
    ...
    def render(self, task: "Task") -> ProgressBar:
        ...
        return ProgressBar(
            total=max(
                0,
                task.total) if task.total is not None else None,
            completed=max(
                0,
                task.completed),
            width=None if self.bar_width is None else max(
                1,
                self.bar_width),
...
class DownloadColumn(ProgressColumn):
    ...
    def __init__(self, binary_units: bool = False,
                 table_column: Optional[Column] = None) -> None:
...
class Task:
    ...
    _progress: Deque[ProgressSample] = field(
        default_factory=lambda: deque(
            maxlen=1000), init=False, repr=False)
    ...
    def speed(self) -> Optional[float]:
        ...
        with self._lock:
            ...
            next(iter_progress)
            total_completed = sum(
                sample.completed for sample in iter_progress)
...
class Progress(JupyterMixin):
    ...
    def open(
        ...
        *,
        ...
        # patch buffering to provide the same behaviour as the builtin
        # `open`
