        ...
        while True:
            try:
                ...
                if previous_state == GzipDecoderState.OTHER_MEMBERS:
                    # Allow trailing garbage acceptable in other gzip
                    # clients
                    return bytes(ret)
                raise
...
class MultiDecoder(object):
    ...
    def __init__(self, modes):
        self._decoders = [_get_decoder(m.strip())
...
class HTTPResponse(io.IOBase):
    ...
    def __init__(
        ...
        # Don't incur the penalty of creating a list and then discarding
        # it
    ...
    def _init_length(self, request_method):
        ...
        if length is not None:
            ...
            try:
                ...
                # all values are the same. Otherwise, the header is
                # invalid.
    ...
    def _error_catcher(self):
        ...
        try:
            try:
                ...
                # there is yet no clean way to get at it from this
                # context.
    ...
    def _fp_read(self, amt):
        ...
        if (
            ...
            return self._fp.read(
                amt) if amt is not None else self._fp.read()
