...
# Data structure for representing the metadata of requests that result
# in a retry.
RequestHistory = namedtuple(
    "RequestHistory", [
        "method", "url", "error", "status", "redirect_location"])
...
class Retry(object):
    ...
    def get_backoff_time(self):
        ...
        :rtype: float
        """
        # We want to consider only the last consecutive errors sequence
        # (Ignore redirects).
    ...
    def increment(
        ...
        if error and self._is_connection_error(error):
            ...
            # status_forcelist and the given method is in the
            # allowed_methods
        ...
        if new_retry.is_exhausted():
            raise MaxRetryError(
                _pool, url, error or ResponseError(cause))
