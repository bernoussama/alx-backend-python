...
# Maps the length of a digest to a possible hash function producing this
# digest
    ...
    class SSLContext(object):  # Platform-specific: Python 2
        ...
        def wrap_socket(
            ...
            warnings.warn(
                ...
                "#ssl-warnings", InsecurePlatformWarning, )
            kwargs = {
...
def ssl_wrap_socket(
    ...
    if keyfile and key_password is None and _is_key_file_encrypted(
            keyfile):
        raise SSLError(
    ...
    use_sni_hostname = server_hostname and not is_ipaddress(
        server_hostname)
    # SecureTransport uses server_hostname in certificate verification.
    send_sni = (use_sni_hostname and HAS_SNI) or (
        IS_SECURETRANSPORT and server_hostname
    )
    # Do not warn the user if server_hostname is an invalid SNI
    # hostname.
