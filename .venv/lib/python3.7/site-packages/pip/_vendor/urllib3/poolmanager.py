...
# pools, or the underlying connections. This is used to construct a pool
# key.
_key_fields = (
    "key_scheme",  # str
    "key_host",  # str
...
ProxyConfig = collections.namedtuple(
...
def _default_key_normalizer(key_class, request_context):
    ...
    # These are both dictionaries and need to be transformed into
    # frozensets
...
class PoolManager(RequestMethods):
    ...
    def connection_from_host(
        ...
        if not port:
            port = port_by_scheme.get(
                request_context["scheme"].lower(), 80)
    ...
    def urlopen(self, method, url, redirect=True, **kw):
        ...
        conn = self.connection_from_host(
            u.host, port=u.port, scheme=u.scheme)
        ...
        # conn.is_same_host() which may use socket.gethostbyname() in
        # the future.
