...
class HebrewProber(CharSetProber):
    ...
    def feed(self, byte_str: Union[bytes, bytearray]) -> ProbingState:
        ...
        if self.state == ProbingState.NOT_ME:
            # Both model probers say it's not them. No reason to
            # continue.
        ...
        for cur in byte_str:
            if cur == self.SPACE:
                ...
                if (
                    ...
                    # case (3) [-2:space][-1:final letter][cur:not
                    # space]
                    self._final_char_visual_score += 1
    ...
    def charset_name(self) -> str:
        ...
        # If the final letter score distance is dominant enough, rely on
        # it.
        ...
        # It's not dominant enough, try to rely on the model scores
        # instead.
        modelsub = (
