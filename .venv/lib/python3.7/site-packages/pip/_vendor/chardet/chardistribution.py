...
class CharDistributionAnalysis:
    ...
    def reset(self) -> None:
        ...
        # The number of characters whose frequency order is less than
        # 512
        self._freq_chars = 0

    def feed(self, char: Union[bytes, bytearray],
             char_len: int) -> None:
        """feed a character with known length"""
        if char_len == 2:
            # we only care about 2-bytes character in our distribution
            # analysis
