...
class UniversalDetector:
    ...
    def feed(self, byte_str: Union[bytes, bytearray]) -> None:
        ...
        # First check for known BOMs, since these are guaranteed to be
        # correct
        if not self._got_data:
            ...
            if byte_str.startswith(codecs.BOM_UTF8):
                ...
                self.result = {
                    # TODO: This encoding is not supported by Python.
                    # Should remove?
        ...
        # bigram distributions.
            ...
            if not self._charset_probers:
                ...
                # If we're checking non-CJK encodings, use single-byte
                # prober
    ...
    def close(self) -> ResultDict:
        ...
        # If we have seen non-ASCII, return the best that met
        # MINIMUM_THRESHOLD
        elif self._input_state == InputState.HIGH_BYTE:
            ...
            for prober in self._charset_probers:
                ...
                if prober_confidence > max_prober_confidence:
                    ...
                    max_prober = prober
            if max_prober and (
                    max_prober_confidence > self.MINIMUM_THRESHOLD):
                ...
                # Rename legacy encodings with superset encodings if
                # asked
