...
try:
    ...
    def _dnsname_match(dn, hostname, max_wildcards=1):
        ...
        # the wildcard character comprises a label other than the
        # left-most label.
        if leftmost == '*':
...
try:
    ...
    def which(cmd, mode=os.F_OK | os.X_OK, path=None):
        ...
        def _access_check(fn, mode):
            return (os.path.exists(fn) and os.access(
        ...
        if sys.platform == "win32":
            ...
            # what file suffixes are executable, so just pass on cmd
            # as-is.
            files = [cmd]
...
if hasattr(BaseZipFile, '__enter__'):  # pragma: no cover
    ...
    class ZipExtFile(BaseZipExtFile):
        ...
        def __exit__(self, *exc_info):
            self.close()
            # return None, so if an exception occurred, it will
            # propagate
    ...
    try:
        ...
        def _recursive_repr(fillvalue='...'):
            ...
            def decorating_function(user_function):
                ...
                # Can't use functools.wraps() here because of bootstrap
                # issues
...
try:
    ...
    class OrderedDict(dict):
        ...
        # Each link is stored as a list of length three:  [PREV, NEXT,
        # KEY].
