...
def encode_path(value):
    ...
    if not isinstance(value, (str, bytes)):
        value = repr(value) if isinstance(
            value, type) else repr(
            type(value))
...
def run():
    ...
    for key in path_keys:
        ...
        value = encode_list_path(value) if isinstance(
            value, list) else encode_path(value)
    ...
    # try to print out, this will validate if other core modules are
    # available (json in this case)
    try:
