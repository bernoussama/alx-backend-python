...
class CPythonmacOsFramework(CPython, ABC):
    ...
    def can_describe(cls, interpreter):
        return is_mac_os_framework(
            interpreter) and super().can_describe(interpreter)
    ...
    def _executables(cls, interpreter):
        for _, targets, must, when in super()._executables(interpreter):
            ...
            # See
            # http://groups.google.com/group/python-virtualenv/browse_thread/thread/17cab2f85da75951
            fixed_host_exe = Path(
...
def _builtin_change_mach_o(maxint):  # noqa: C901
    ...
    def mach_o_change(at_path, what, value):  # noqa: C901
        ...
        def do_macho(file, bits, endian):
            # Read Mach-O header (the magic number is assumed read by
            # the caller)
            ...
            for _ in range(n_commands):
                ...
                if cmd == LC_LOAD_DYLIB:
                    ...
                    # If the string is what is being replaced, overwrite
                    # it.
                    if load == what:
                        file.seek(where + name_offset, os.SEEK_SET)
