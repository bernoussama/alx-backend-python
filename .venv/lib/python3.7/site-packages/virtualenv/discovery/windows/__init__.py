...
# Map of well-known organizations (as per PEP 514 Company Windows
# Registry key part) versus Python implementation
...
def propose_interpreters(spec, cache_dir, env):
    ...
    # and prefer PythonCore over conda pythons (as virtualenv is mostly
    # used by non conda tools)
    ...
    for name, major, minor, arch, exe, _ in existing:
        ...
        # Pre-filtering based on Windows Registry metadata, for CPython
        # only
