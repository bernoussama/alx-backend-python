...
def translate_pattern(glob):
    ...
    # This will split on '/' within [character classes]. This is
    # deliberate.
    ...
    for c, chunk in enumerate(chunks):
        ...
        # Chunks that are a literal ** are globstars. They match
        # anything.
        if chunk == '**':
            if last_chunk:
        ...
        while i < chunk_len:
            ...
            if char == '*':
                ...
                if inner_i >= chunk_len:
                    ...
                    # Do not treat this as a matching group, but as a
                    # literal [
                    pat += re.escape(char)
                else:
...
class egg_info(InfoCommon, Command):
    ...
    def run(self):
        ...
        # Get rid of native_libs.txt if it was put there by older
        # bdist_egg
    ...
    if isinstance(ep, six.string_types) or ep is None:
        ...
        for section, contents in sorted(ep.items()):
            if not isinstance(contents, six.string_types):
                ...
                contents = '\n'.join(
                    sorted(map(str, contents.values())))
            data.append('[%s]\n%s\n\n' % (section, contents))
        data = ''.join(data)
