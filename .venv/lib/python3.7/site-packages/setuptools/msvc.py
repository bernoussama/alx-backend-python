...
def msvc9_query_vcvarsall(ver, arch='x86', *args, **kwargs):
    ...
    try:
        ...
        # Pass error if environment not set after executing
        # vcvarsall.bat
        pass
...
def _msvc14_find_vc2017():
    ...
    """
    root = environ.get(
        "ProgramFiles(x86)") or environ.get("ProgramFiles")
    if not root:
        return None, None
...
def msvc14_gen_lib_options(*args, **kwargs):
    ...
    if "numpy.distutils" in sys.modules:
        ...
        if LegacyVersion(np.__version__) < LegacyVersion('1.11.2'):
            return np.distutils.ccompiler.gen_lib_options(
                *args, **kwargs)
...
def _augment_exception(exc, version, arch=''):
    ...
    if "vcvarsall" in message.lower() or "visual c" in message.lower():
        ...
        if version == 9.0:
            ...
            # For VC++ 14.X Redirect user to latest Visual C++ Build
            # Tools
...
class SystemInfo:
    ...
    def find_programdata_vs_vers(self):
        ...
        for name in hashed_names:
            try:
                ...
                # Raises OSError if this VS installation does not
                # contain VC
    ...
    def VSInstallDir(self):
        ...
        return self.ri.lookup(
            self.ri.vs,
            '%0.1f' %
            self.vs_ver) or default
    ...
    def _guess_vc_legacy(self):
        ...
        # Try to get "VC++ for Python" path from registry as default
        # path
    ...
    def UniversalCRTSdkLastVersion(self):
        ...
        return self._use_last_dir_name(
            join(self.UniversalCRTSdkDir, 'lib'))
...
class EnvironmentInfo:
    ...
    def VCTools(self):
        ...
        if self.vs_ver == 14.0:
            ...
            tools += [join(si.VCInstallDir, host_dir %
                           self.pi.target_dir(x64=True))]

            if self.pi.current_cpu != self.pi.target_cpu:
                tools += [join(si.VCInstallDir, host_dir %
                               self.pi.current_dir(x64=True))]
    ...
    def VCRuntimeRedist(self):
        ...
        crt_dirs = ('Microsoft.VC%d.CRT' % (self.vc_ver * 10),
                    # Sometime store in directory with VS version
                    # instead of VC
